            ...
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                ...
                <div className='mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20'>
                    <AnimatedText className='mb-10 flex w-[100%] flex-col gap-y-4 text-[18px] font-medium leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16 lg:max-w-[90%] lg:text-[24px]'>
                        <p>
                            Hola! I am software engineer with a passion for creating innovative solutions and experiences. I specialize in web development, delivering creative and effective solutions that exceed expectations.
                        </p>
                        <p>
                            Skilled in web development, and  I thrive on precision, problem-solving, and collaboration.
                        </p>
                        <p>
                            Beyond code, I find creativity—through sketching, and the limitless worlds of fantasy novels. Staying ahead in technology fuels my passion for learning and growth.
                        </p>
                        <p>
                            Music is my escape, where soaring melodies, introspective lyrics, and timeless rhythms resonate deeply. 
                        </p>
                    </AnimatedText>
                    ...
                    <aside className='mb-24 flex w-[100%] flex-col gap-4 text-[18px] font-normal leading-relaxed tracking-wide text-[#e4ded7]/80 sm:mb-32 md:mb-40 md:gap-6 md:text-[16px] md:leading-normal lg:mt-0 lg:mb-16 lg:max-w-[30%] lg:text-[18px]'>
                        <div className='flex flex-col gap-4 md:gap-10'>
                            <Skills
                                ...
                                details={"JavaScript, React, HTML5"}
                            />
                            <Skills
                                words={[['B', 'A', 'C', 'K', 'E', 'N', 'D'], ['T', 'O', 'O', 'L', 'S']]}
                                details={"Node.js, Express, MongoDB, Mongoose, RESTful APIs"}
                            />
                            {/* <Skills
